...
//Envio de información a Chatbase libreria @google/chatbase
	...
	.catch(err => console.error(err));
//Envio de información a Google Analytics libreria request
	const url2 = 'https://www.google-analytics.com/collect?v=1&t=event&tid=UA-111480355-1&cid='+req.body.sessionId+'&dh=www.google-analytics.com&ec=Intento&ea='+req.body.result.metadata.intentName+'&el='+req.body.result.resolvedQuery+'&ev=1&aip=1';     	
